...
public class TranslatableMessage {
	 ...
	 */
	public TranslatableMessage(@NotNull BukkitPlugin plugin, @NotNull String key, @NotNull String... args) {
		this.plugin = plugin;
	 ...
	 */
	public @NotNull String getMessage(@NotNull String language, @NotNull String... args) {
	 ...
	 * @return the translated message
	 */
	public @NotNull String getMessage(@NotNull CommandSender sender, @NotNull String... args) {
	...
	public static class TranslatableMessageException extends IllegalArgumentException {
		 ...
		 */
		public TranslatableMessageException(@NotNull String key) {
			super(key);
		}
